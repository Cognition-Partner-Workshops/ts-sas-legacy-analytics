...
| 3 | **DEC-016 approved (a) 2026-09-02** (append vs overwrite for `acct_exceptions` / `txn_rejected`). Multi-day accumulation semantics unknown; single-date parity only. | Requester | decision recorded in `06_decisions.md` |
